  ...
  return (
    <div className="pb-20 px-4">
        <div className="container mx-auto text-center">
            <h1 className="text-5xl md:text-8xl lg:text-[100px] pb-6 custom-gradient-text custom-gradie nt-bg">
            ...
            <div className="hero-image-wrapper">
                <div ref={imageRef} className="hero-image">
                    <Image src="/banner1.jpg" width={1200} height={720} alt="Preview"  className="rounded-lg shadow-2xl board mx-auto" priority/>
                </div>
            </div>
        </div>
    </div>
