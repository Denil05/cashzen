            ...
            <div className="px-4 pb-4">
                <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="balance" placeholder="e.g.,0.00" step="0.01" type="number" {...register("balance")}/>
                        {errors.balance && (
                    ...
                    <div className="flex items-center justify-between rounded-lg border p-3">
                        <div className="space-y-0.5">
                            <label htmlFor="name" className="text-sm font-medium cursor-pointer">Set as Default</label>
                            <p className='text-sm text-muted-foreground'>This account is selected by default for transaction</p>
                        </div>
